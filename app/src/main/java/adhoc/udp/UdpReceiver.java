...
public class UdpReceiver implements Runnable{
	...
	private final static String MSG_TAG = "AdHoc --> UdpReceiver";
	...
	public UdpReceiver(Receiver parent, int nodeAddress) throws SocketException, UnknownHostException, BindException{
		...
		datagramSocket = new DatagramSocket(new InetSocketAddress(/*"192.168.2."+nodeAddress ,*/ Constants.AODV_RECEIV_PORT));
		
		datagramSocket.setBroadcast(true);
		udpBroadcastReceiver = new UdpBroadcastReceiver(Constants.AODV_RECEIV_PORT);
	}
